...
<section id="page-heading" class="page-heading">
    <div class="container">
        <div class="col-md-12 padding-clear">
            <h2 class="darkblue text42">Возникли вопросы? Звоните!</h2>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 padding-clear">
                <div class="row">
                    <div class="col-md-12 padding-clear">
                        <div class="col-md-4 text-center"><img style="width: 139px;" src="{{ asset('frontend/images/icons/flag_r.png')}}">
                            <h4 class="darkblue bold-text text20">Офис в России</h4>
                            <div class="panel">
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/destination.png')}}"></div>
                                    <div class="media-body text-left">
                                        <p class="darkblue text16">101000 Москва Лубянский проезд, д. 15, стр. 4</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/email.png')}}"></div>
                                    <div class="media-body text-left"><a class="text16" href="#" data-original-title="" title="">info@mysanatorium.com</a></div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                        <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/telephone_red.png')}}"></div>
                                        <div class="media-body text-left">
                                            <p class="red text16">Телефон: Whatsapp | Telegram | Viber:&nbsp;</p>
                                            <p class="red text16">+79683815259</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-center"><img style="width: 139px;" src="{{ asset('frontend/images/icons/flag_u.png')}}">
                            <h4 class="darkblue bold-text text20">Офис в Украине</h4>
                            <div class="panel">
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/destination.png')}}"></div>
                                    <div class="media-body text-left">
                                        <p class="darkblue text16">04201, Киев проспект Героев Сталинграда, д. 12</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/email.png')}}"></div>
                        ...
                        <div class="col-md-4 text-center"><img style="width: 139px;" src="{{ asset('frontend/images/icons/flag_a.png')}}">
                            <h4 class="darkblue bold-text text20">Офис в Азербайджане</h4>
                            <div class="panel">
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/destination.png')}}"></div>
                                    <div class="media-body text-left">
                                        <p class="darkblue text16">AZ 1025, Баку А. Исмайлов 035 С</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/email.png')}}"></div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body text-left">
                                        <p class="red text16">Телефон: Whatsapp | Telegram | Viber:&nbsp;</p>
                                        <p class="red text16">+994554103570</p>
                                    </div>
                                </div>
                                <div class="media">&nbsp;</div>
                            </div>
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-12 padding-clear">
                        <div class="col-md-4 col-md-offset-2 text-center"><img style="width: 139px;" src="{{ asset('frontend/images/icons/flag_g.png')}}">
                            <h4 class="darkblue bold-text text20">Офис в Грузии</h4>
                            <div class="panel">
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/destination.png')}}"></div>
                                    <div class="media-body text-left">
                                        <p class="darkblue text16">0172, Тбилиси Глдани-Надзаладеви, д. 10</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/email.png')}}"></div>
                        ...
                        <div class="col-md-4 text-center"><img style="width: 139px;" src="{{ asset('frontend/images/icons/flag_k.png')}}">
                            <h4 class="darkblue bold-text text20">Офис в Казахстане</h4>
                            <div class="panel">
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/destination.png')}}"></div>
                                    <div class="media-body text-left">
                                        <p class="darkblue text16">050040, Алматы БЦ «Коктем Квадрат» офис №6</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"><img class="media-object" src="{{ asset('frontend/images/icons/email.png')}}"></div>
...
<section id="page-doctor-form">
    <div class="container">
        <form id="help-request-form" action="/svyajitesj-s-nami#visit_bottom" method="post">
            <input type="hidden" name="_csrf" value="sPOLPkHTqVTJ6uPp68i1bMCBZBtrKPoypW_l3azJ9dfmuccMAJ3hPL2GiNyi_PgujcQzaBFJ10L1Kpye74iFuQ==">
            <div class="row">
                <div class="col-md-12 padding-clear text-center">
                    <h2 class="text-white text31 bold-text margin-clear">Как мы можем вам помочь?</h2>
                </div>
            </div>
            <div class="doctor-form">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <div class="form-group field-howhelpform-firstname required">
                                <input type="text" id="howhelpform-firstname" class="form-control select-blue-colored" name="HowHelpForm[firstname]" placeholder="Имя" aria-required="true">
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group field-howhelpform-phone required">
                                <div class="intl-tel-input allow-dropdown">
                                    ...
                                    </div><input type="text" id="howhelpform-phone" class="form-control select-blue-colored" name="HowHelpForm[phone]" placeholder="Телефон" aria-required="true" autocomplete="off">
                                </div>
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group field-howhelpform-email required">
                                <input type="text" id="howhelpform-email" class="form-control select-blue-colored" name="HowHelpForm[email]" placeholder="Адрес электронной почты" aria-required="true">
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="form-group">
                                <div class="form-group field-howhelpform-message required">
                                    <textarea id="howhelpform-message" class="form-control select-blue-colored" name="HowHelpForm[message]" placeholder="Ваш вопрос" style="resize:vertical;height:150px;" aria-required="true"></textarea>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="form-group text-center">
                                <button type="submit" class="btn-extra-sanatorium bold-text text-center btn-choose-sanatorium front_btn_submit" style="display:inline-block;margin-top:15px;width:50%;height:44px;">Отправьте ваш вопрос</button>
                            </div>
                            <p class="text-white margin-top-10 text14">Наш координатор ответит на Ваши вопросы</p>
                        </div>
                    </div>
                </div>
            </div>
