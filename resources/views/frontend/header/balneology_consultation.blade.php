...
<section id="page-head" class="page-background" style="background: url('frontend/images/konsuljtatsiya-vrachey.jpg');background-size:cover;background-position:center center;background-repeat:no-repeat;">
    <div class="container">
        <div class="col-md-8">
            <h1 class="text31 darkblue text-uppercase">ВОСПОЛЬЗУЙТЕСЬ БЕСПЛАТНЫМИ КОНСУЛЬТАЦИЯМИ ВРАЧЕЙ–КУРОРТОЛОГОВ</h1>
            <h3 class="text24 text-lightblue text-uppercase">ВАМ ОПЕРАТИВНО ОТВЕТЯТ НА ВСЕ ИНТЕРЕСУЮЩИЕ ВОПРОСЫ</h3>
        </div>
    </div>
</section>

<section style="background-color: #e8edf0;">
    <div class="container">
        <div class="col-md-12 padding-clear">
            <div class="row" style="margin:20px 0;">
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5712290e70828.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Матанат Кулиева </h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5b9faaea88c00.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Гюльтакин Сулейманова</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5d29ca33bbf96.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Нана Куртанидзе</h3>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom:20px;">
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5735ecffbaf28.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Николай Коваль</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5ba49856794fc.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Шариф Шахмамедов</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5c8f4bbaef92e.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Шахин Бабаев </h3>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom:20px;">
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5c8caee19f032.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Севда Гаджизаде</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5c8d0ec68fb84.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Ирма Ланчава</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5c8f4c0fc215e.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Давид Маргвелашвили</h3>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom:20px;">
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5c8fabcfd65c2.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Дали Иоселиани</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="margin-tb-20">
                        <div class="consultant-img inline-block">
                            <div><img src="{{ asset('frontend/upload/services/item/5e663215c3197.jpg')}}" class="media-object"></div>
                        </div>
                    </div>
                    <div>
                        <h3 class="darkblue bold-text">Асланова Кенуль </h3>
                    </div>
                </div>
            </div>
        </div>
...
<section id="page-heading" class="page-heading">
    <div class="container">
        <div class="col-md-12 padding-clear">
            <h2 class="darkblue text42">Консультация врача</h2>
        </div>
    </div>
</section>

<section id="page-body" class="text15">
    <div class="container"><span style="font-size: 12pt;"><strong>Почему так важно выбрать курорт или санаторий, проконсультировавшись с врачом-курортологом?</strong></span></div>
    <div class="container"><br>
        <p><span style="font-size: 16px;">После прохождения лечебного курса у лечащего врача рекомендуется пройти санаторно-курортное лечение или реабилитацию в одном из известных курортов. Однако следует учитывать, что лечащий врач не всегда четко знает особенности специализации курортов, а туристическое агентство имеет своей целью выгоднее продать путевку, не заботясь об эффекте, который Вы получите в результате.</span></p>
        <p><span style="font-size: 12pt;">На нашем сайте Вы можете обратиться к лучшим врачам-курортологам, знающим тот или иной регион на очень высоком уровне. Вы получите консультацию абсолютно бесплатно и обретете полную уверенность в правильности сделанного выбора. Врачи-курортологи быстро подберут для Вас лучший санаторий или курорт, а также предоставят индивидуальные рекомендации. Для этого достаточно заполнить заявку, размещенную ниже, и отправить ее нам.</span></p>
    </div>
</section>

<section id="page-doctor-form">
    <div class="container">
        <div class="row">
            <div class="col-md-12 padding-clear text-center">
                <h2 class="text-white text31 bold-text margin-clear">Задайте вопрос врачу!</h2>
                <h4 class="text26 text-white margin-bottom-clear">В течении 48 часов получите ответ от врача
                    консультанта.</h4>
            </div>
        </div>
        <div class="doctor-form">
            <form id="send-message-doctor" action="https://mysanatorium.com/konsuljtatsiya-vrachey#visit_bottom" method="post" novalidate="novalidate">
                <input type="hidden" name="_csrf" value="Icv_o2KiGicBBDaKxSRteaeM8ihvj4QaAmzYz5V197Ny_p3uKM1Fa1FSUf-uTFoh7fiAcjDj1W5nOuin4R7P8A==">
                <div class="row">
                    <div class="col-md-12 padding-clear">
                        <div class="col-md-4">
                            <input type="text" class="form-control select-blue-colored" name="firstname" placeholder="Имя" style="border:1px solid #d9d9d9;">
                        </div>
                        <div class="col-md-4">
                            <div class="intl-tel-input allow-dropdown">
                                <div class="flag-container">
                                    ...
                                    <ul class="country-list hide">
                                        ...
                                        <li class="country highlight" data-dial-code="61" data-country-code="au">
                                            <div class="flag-box">
                                ...
                                </div><input type="text" class="form-control select-blue-colored" name="phone" placeholder="Телефон" autocomplete="off">
                            </div>
                            <span id="error-msg" class="hide" style="color:#a94442;">Пожалуйста, укажите верный номер</span>
                        </div>
                        <div class="col-md-4">
                            <input type="email" class="form-control select-blue-colored" name="email" placeholder="Адрес электронной почты" style="border:1px solid #d9d9d9;">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <textarea class="form-control select-blue-colored" rows="5" name="message" style="resize: vertical;border:1px solid #d9d9d9;border-radius: 0px;" placeholder="Ваше сообщение"></textarea>
                        <input type="hidden" name="form-consultant" value="1">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <button id="btn-message-doctor" class="btn-extra-sanatorium text-uppercase text-center btn-choose-sanatorium" style="display:inline-block;margin-top: 15px;width: 100%;height:44px;font-size:21px;">
