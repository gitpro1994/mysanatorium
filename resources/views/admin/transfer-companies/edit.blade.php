...
@section('page-title', 'Transfer şirkəti məlumatları')
@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.transfer-companies.update', ['id'=>$company->id]) }}" method="POST">
            @csrf
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-8 col-xl-9">
                    <input type="email" name="reservation_email" value="{{ $company->email }}" class="form-control" id="reservation_email" placeholder="info@mysanatorium.com">
