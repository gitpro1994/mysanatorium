...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.sanatoriums.room-kinds.store', ['sanatorium_id'=>$sanatorium->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <label for="name" class="col-4 col-xl-3 col-form-label">Sanatoriya</label>
                <div class="col-8 col-xl-9">
                    <h4>{{ $sanatorium->name }}</h4>
                    <input type="hidden" value="{{ $sanatorium->id }}" name="sanatoriums_id">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-8 col-xl-9">
                    <input type="text" class="form-control" name="bed_width" id="bed_width">
                    @error('bed_width')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
             ...
             <div class="row mb-3">
                ...
                <div class="col-8 col-xl-9">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="smoking" class="form-check-input" id="smoking">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-8 col-xl-9">
                        <textarea name="room_features" class="form-control" id="room_features" cols="30" rows="10"></textarea>
                        @error('room_features')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                </div>
                ...
                <div class="col-8 col-xl-9">
                	<div class="row">
                        ...
                        <div class="col-md-3">
                        	...
                        	<input type="checkbox" id="element-{{ $element->id }}" value="{{ $element->id }}" name="room_amenities[]">
                        	{{ $element->name }}
                        </label>
                        </div>
                        @endforeach
