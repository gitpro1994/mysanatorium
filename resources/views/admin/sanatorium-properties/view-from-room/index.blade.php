...
@section('page-title', 'Otaqdan görünüş')
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                @endif
                <div class="float-end">
                    <a href="{{ route('admin.view-from-rooms.create') }}">
                        <button class="btn btn-sm btn-info">
                        <span>
                            <i class="fas fa-plus"></i>
                        </span>
                            Yeni otaqdan görünüş
                        </button>
                    </a>
                </div>
                ...
                <table id="basic-datatable" class="table dt-responsive table-bordered nowrap w-100">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.view-from-rooms.edit', ['id'=>$type->id]) }}">
                            ...
                            <a href="{{ route('admin.view-from-rooms.destroy', ['id'=>$type->id]) }}">
...
<script>
    $(function () {
        $('.element-status').click(function (e) {
            ...
            $.ajax({
                url:"{{ url('admin/sanatorium-properties/view-from-rooms/check_status') }}"+"/"+id,
                type:"POST",
                data:{
                    "_token": "{{ csrf_token() }}",
                    "id":id
