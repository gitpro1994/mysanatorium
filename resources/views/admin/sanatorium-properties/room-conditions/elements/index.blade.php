        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-start">
                    <h4 class="text-primary">{{ $room_condition->name }}</h4>
                </div>
                <div class="float-end">
                    <a href="{{ URL::previous() }}">
                    ...
                    <a href="{{ route('admin.elements.create', ['room_condition_id'=>$room_condition->id]) }}">
            ...
            <div class="card-body">
                <table id="basic-datatable" class="table dt-responsive table-bordered nowrap w-100">
                    ...
                    <tr>
                        <td>{{$element->name}}</td>
                        <td>
                            <button type="button" data-id="{{ $element->id }}" class="btn btn-sm btn-outline-{{ ($element->show_filter==1 ? 'success' : 'danger') }} waves-effect waves-light element-status">{{ ($element->show_filter==1 ? 'Göztərilir' : 'Göstərilmir') }}</button></td>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.elements.destroy', ['id'=>$element->id]) }}">
                                <button class="btn btn-sm btn-danger">
                                    <span>
