...
@section('page-title', 'Otaq növləri')
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                @endif
                <div class="float-end">
                    <a href="{{ route('admin.room-kinds.create') }}">
                ...
                <table id="basic-datatable" class="table dt-responsive table-bordered nowrap w-100">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.room-kinds.edit', ['id'=>$room->id]) }}">
                            ...
                            <a href="{{ route('admin.room-kinds.destroy', ['id'=>$room->id]) }}">
...
<script>
    $(function () {
        $('.element-status').click(function (e) {
            ...
            $.ajax({
                url:"{{ url('admin/sanatorium-properties/room-kinds/check_status') }}"+"/"+id,
                type:"POST",
                data:{
                    "_token": "{{ csrf_token() }}",
                    "id":id
